...
XCURSOR_TRANSPARENT_THEME_URL		:= https://matchbox-project.org/sources/utils/$(XCURSOR_TRANSPARENT_THEME).$(XCURSOR_TRANSPARENT_THEME_SUFFIX);no-check-certificate
