...
# Paths and names
#
HOSTTOOLS_FAKEROOT_VERSION	= 1.2.2
HOSTTOOLS_FAKEROOT		= fakeroot-$(HOSTTOOLS_FAKEROOT_VERSION)
HOSTTOOLS_FAKEROOT_SUFFIX	= tar.gz
HOSTTOOLS_FAKEROOT_URL		= $(DEBPOOL_MIRROR)/pool/main/f/fakeroot/fakeroot_$(HOSTTOOLS_FAKEROOT_VERSION).$(HOSTTOOLS_FAKEROOT_SUFFIX)
