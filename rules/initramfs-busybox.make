...
INITRAMFS_BUSYBOX_PKGDIR	:= $(PKGDIR)/$(INITRAMFS_BUSYBOX)
...
initramfs-busybox_clean:
	rm -rf $(STATEDIR)/initramfs-busybox.*
	rm -rf $(PKGDIR)/initramfs-busybox{-,_}*
	rm -rf $(INITRAMFS_BUSYBOX_DIR)
