...
KERNEL_HOST_VERSION_MAJOR	:= $(shell echo $(PTXCONF_KERNEL_HOST_VERSION) | sed "s/\([0-9]*\).\([0-9]*\).\([0-9]*\)/\1/")
KERNEL_HOST_VERSION_MINOR	:= $(shell echo $(PTXCONF_KERNEL_HOST_VERSION) | sed "s/\([0-9]*\).\([0-9]*\).\([0-9]*\)/\2/")
KERNEL_HOST_VERSION_MICRO	:= $(shell echo $(PTXCONF_KERNEL_HOST_VERSION) | sed "s/\([0-9]*\).\([0-9]*\).\([0-9]*\)/\3/")
