# -*-makefile-*-
# $Id: mfirebird.make,v 1.1 2003/08/12 07:24:44 robert Exp $
#
...
$(STATEDIR)/mfirebird.prepare: $(mfirebird_prepare_deps)
	...
	cd $(MFIREBIRD_DIR) && \
		...
		$(MFIREBIRD_DIR)/configure $(MFIREBIRD_AUTOCONF)
	touch $@
...
$(STATEDIR)/mfirebird.compile: $(mfirebird_compile_deps)
	...
	$(MFIREBIRD_PATH) make -C $(MFIREBIRD_DIR)
	touch $@
