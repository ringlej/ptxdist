...
ifdef PTXCONF_MESALIB_DRI_I810
	@$(call install_copy, mesalib, 0, 0, 0755, $(MESALIB_DIR)/lib/i810_dri.so, /usr/lib/dri/i810_dri.so)
endif
ifdef PTXCONF_MESALIB_DRI_I965
	@$(call install_copy, mesalib, 0, 0, 0755, $(MESALIB_DIR)/lib/i965_dri.so, /usr/lib/dri/i965_dri.so)
endif
ifdef PTXCONF_MESALIB_DRI_MACH64
	@$(call install_copy, mesalib, 0, 0, 0755, $(MESALIB_DIR)/lib/mach64_dri.so, /usr/lib/dri/mach64_dri.so)
endif
ifdef PTXCONF_MESALIB_DRI_MGA
	@$(call install_copy, mesalib, 0, 0, 0755, $(MESALIB_DIR)/lib/mga_dri.so, /usr/lib/dri/mga_dri.so)
endif
ifdef PTXCONF_MESALIB_DRI_R128
	@$(call install_copy, mesalib, 0, 0, 0755, $(MESALIB_DIR)/lib/r128_dri.so, /usr/lib/dri/r128_dri.so)
endif
ifdef PTXCONF_MESALIB_DRI_R200
	@$(call install_copy, mesalib, 0, 0, 0755, $(MESALIB_DIR)/lib/r200_dri.so, /usr/lib/dri/r200_dri.so)
endif
ifdef PTXCONF_MESALIB_DRI_R300
	@$(call install_copy, mesalib, 0, 0, 0755, $(MESALIB_DIR)/lib/r300_dri.so, /usr/lib/dri/r300_dri.so)
endif
...
ifdef PTXCONF_MESALIB_DRI_SAVAGE
	@$(call install_copy, mesalib, 0, 0, 0755, $(MESALIB_DIR)/lib/savage_dri.so, /usr/lib/dri/savage_dri.so)
endif
ifdef PTXCONF_MESALIB_DRI_SIS
	@$(call install_copy, mesalib, 0, 0, 0755, $(MESALIB_DIR)/lib/sis_dri.so, /usr/lib/dri/sis_dri.so)
endif
ifdef PTXCONF_MESALIB_DRI_TDFX
	@$(call install_copy, mesalib, 0, 0, 0755, $(MESALIB_DIR)/lib/tdfx_dri.so, /usr/lib/dri/tdfx_dri.so)
endif
ifdef PTXCONF_MESALIB_DRI_TRIDENT
	@$(call install_copy, mesalib, 0, 0, 0755, $(MESALIB_DIR)/lib/trident_dri.so, /usr/lib/dri/trident_dri.so)
endif
ifdef PTXCONF_MESALIB_DRI_UNICHROME
	@$(call install_copy, mesalib, 0, 0, 0755, $(MESALIB_DIR)/lib/unichrome_dri.so, /usr/lib/dri/unichrome_dri.so)
endif
ifdef PTXCONF_MESALIB_DRI_FFB
	@$(call install_copy, mesalib, 0, 0, 0755, $(MESALIB_DIR)/lib/ffb_dri.so, /usr/lib/dri/ffb_dri.so)
endif
