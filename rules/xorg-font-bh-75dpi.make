...
# Paths and names
#
XORG_FONT_BH_75DPI_VERSION	:= 1.0.1
...
xorg-font-bh-75dpi_get: $(STATEDIR)/xorg-font-bh-75dpi.get

$(STATEDIR)/xorg-font-bh-75dpi.get: $(xorg-font-bh-75dpi_get_deps_default)
	@$(call targetinfo, $@)
	@$(call touch, $@)
...
xorg-font-bh-75dpi_extract: $(STATEDIR)/xorg-font-bh-75dpi.extract
...
xorg-font-bh-75dpi_prepare: $(STATEDIR)/xorg-font-bh-75dpi.prepare
...
$(STATEDIR)/xorg-font-bh-75dpi.prepare: $(xorg-font-bh-75dpi_prepare_deps_default)
	@$(call targetinfo, $@)
	@$(call clean, $(XORG_FONT_BH_75DPI_DIR)/config.cache)
	cd $(XORG_FONT_BH_75DPI_DIR) && \
		$(XORG_FONT_BH_75DPI_PATH) $(XORG_FONT_BH_75DPI_ENV) \
		./configure $(XORG_FONT_BH_75DPI_AUTOCONF)
	@$(call touch, $@)
...
xorg-font-bh-75dpi_compile: $(STATEDIR)/xorg-font-bh-75dpi.compile
...
xorg-font-bh-75dpi_install: $(STATEDIR)/xorg-font-bh-75dpi.install

$(STATEDIR)/xorg-font-bh-75dpi.install: $(xorg-font-bh-75dpi_install_deps_default)
	@$(call targetinfo, $@)
	@$(call touch, $@)
...
xorg-font-bh-75dpi_targetinstall: $(STATEDIR)/xorg-font-bh-75dpi.targetinstall
