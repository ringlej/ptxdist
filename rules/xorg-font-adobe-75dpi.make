...
# Paths and names
#
XORG_FONT_ADOBE_75DPI_VERSION	:= 1.0.1
...
xorg-font-adobe-75dpi_get: $(STATEDIR)/xorg-font-adobe-75dpi.get

$(STATEDIR)/xorg-font-adobe-75dpi.get: $(xorg-font-adobe-75dpi_get_deps_default)
	@$(call targetinfo, $@)
	@$(call touch, $@)
...
xorg-font-adobe-75dpi_extract: $(STATEDIR)/xorg-font-adobe-75dpi.extract
...
xorg-font-adobe-75dpi_prepare: $(STATEDIR)/xorg-font-adobe-75dpi.prepare
...
$(STATEDIR)/xorg-font-adobe-75dpi.prepare: $(xorg-font-adobe-75dpi_prepare_deps_default)
	@$(call targetinfo, $@)
	@$(call clean, $(XORG_FONT_ADOBE_75DPI_DIR)/config.cache)
	cd $(XORG_FONT_ADOBE_75DPI_DIR) && \
		$(XORG_FONT_ADOBE_75DPI_PATH) $(XORG_FONT_ADOBE_75DPI_ENV) \
		./configure $(XORG_FONT_ADOBE_75DPI_AUTOCONF)
	@$(call touch, $@)
...
xorg-font-adobe-75dpi_compile: $(STATEDIR)/xorg-font-adobe-75dpi.compile
...
xorg-font-adobe-75dpi_install: $(STATEDIR)/xorg-font-adobe-75dpi.install
...
xorg-font-adobe-75dpi_targetinstall: $(STATEDIR)/xorg-font-adobe-75dpi.targetinstall
...
xorg-font-adobe-75dpi_clean:
	rm -rf $(STATEDIR)/xorg-font-adobe-75dpi.*
	rm -rf $(PKGDIR)/xorg-font-adobe-75dpi_*
	rm -rf $(XORG_FONT_ADOBE_75DPI_DIR)
