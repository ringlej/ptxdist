...
#
ifdef PTXCONF_HOSTTOOL-IPKG-UTILS
...
HOSTTOOL-IPKG-UTILS_DIR		= $(HOSTTOOLS_BUILDDIR)/$(HOSTTOOL-IPKG-UTILS)
...
$(STATEDIR)/hosttool-ipkg-utils.extract: $(hosttool-ipkg-utils_extract_deps)
	...
	@$(call extract, $(HOSTTOOL-IPKG-UTILS_SOURCE), $(HOSTTOOLS_BUILDDIR))
