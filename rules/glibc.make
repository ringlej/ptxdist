# -*-makefile-*-
# $Id: glibc.make,v 1.25 2004/08/24 14:18:30 rsc Exp $
#
...
GLIBC_ZONEFILES-$(PTXCONF_GLIBC_ZONEINFO_PORTUGAL) += Portugal
GLIBC_ZONEFILES-$(PTXCONF_GLIBC_ZONEINFO_TURKEY) += Turkey
...
GLIBC_ZONEFILES-$(PTXCONF_GLIBC_ZONEINFO_GBEIRE) += GB-Eire
GLIBC_ZONEFILES-$(PTXCONF_GLIBC_ZONEINFO_GREENWICH) += Greenwich
...
GLIBC_ZONEFILES-$(PTXCONF_GLIBC_ZONEINFO_POLAND) += Poland
...
ifdef PTXCONF_GLIBC_GCONV_ISO8859_1
	...
	for target in $(GLIBC_ZONEFILES)-y; do 					\
		cp -a $(GLIBC_ZONEDIR)/$$target $(ROOTDIR)/usr/share/zoneinfo/;	\
	done;
